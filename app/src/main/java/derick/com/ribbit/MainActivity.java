...
public class MainActivity extends FragmentActivity {
    ...
    public static final int FILE_SIZE_LIMIT = 1024 * 1024 * 100; //10MB
  ...
  //  @Override
    ...
    protected DialogInterface.OnClickListener mDialogListener = new DialogInterface.OnClickListener() {
            ...
            switch (which) {
                ...
                case 1:
                    ...
                    if (mMediaUri == null) {
                        ...
                        videoIntent.putExtra(MediaStore.EXTRA_DURATION_LIMIT, 0);//the lowest resolution
        ...
        private Uri getOutputMediaFileUri(int mediaType) {
            //to be safe make sure SD card is mounted
            ...
            if (requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST) {
                ...
                if (requestCode == PICK_VIDEO_REQUEST) {
                    ...
                    try {
                        ...
                        Toast.makeText(this, "just now", Toast.LENGTH_LONG).show();
                        return;
                    } catch (IOException e) {
